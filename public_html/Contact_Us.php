...
/>
 ...
 .main {
        ...
        .b {
            ...
            border-radius: 20px;
            box-shadow: 8px 8px 25px rgba(0, 0, 0, 0.08), -5px -5px 15px #fff;
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
        ...
        textarea:focus {
            outline: none;
            border-color: #a77c4e;
            box-shadow: 0 0 10px rgba(167, 124, 78, 0.2);
        }

        button {
            background: linear-gradient(to right, #a95f3d, #844629);
            color: white;
            padding: 14px;
            font-size: 17px;
            border: none;
...
<a href="https://x.com/kaleen1731371?t=nGRLDTD_SbPgPfgm6wnSrw&s=09"><i class="fa-brands fa-x-twitter"></i></a>
   ...
   <div class="main">
        ...
        <div class="a">
            ...
            <div class="b">
                ...
                <h4>Email</h4>
                <p>mirzapurkalenrugs@gmail.com</p>
            </div>
        </div>

        <div class="contact-container">
            <p class="subtitle">We’d love to hear from you. Our team is always here to help you.</p>
 ...
 <!-- Contact Form -->
            ...
            <div class="info">
                <p><strong>Email:</strong> mirzapurkalenrugs@gmail.com</p>
                <p><strong>Phone:</strong> +91 94152 05761</p>
                <p><strong>Address:</strong>Mahant Ka Shiwala,Mirzapur,Uttar Pradesh, India</p>
        ...
        <div class="warranty-section">
            ...
            <p class="section-subtitle">We stand behind the quality of our handcrafted products with comprehensive warranty coverage and dedicated customer support.</p>

            <div class="warranty-cards">
                <div class="warranty-card">
                    <i class="fas fa-award"></i>
                    <h3>Quality Guarantee</h3>
                    <p>All our carpets come with a 2-year warranty against manufacturing defects, ensuring long-lasting beauty and durability.</p>
                </div>
                <div class="warranty-card">
                    <i class="fas fa-tools"></i>
                    <h3>Repair Services</h3>
                    <p>Professional repair and restoration services available for all our products, extending their lifespan for years to come.</p>
                </div>
                <div class="warranty-card">
                    <i class="fas fa-headset"></i>
                    <h3>Expert Support</h3>
                    <p>Our knowledgeable team is available to provide guidance on care, maintenance, and any product-related questions.</p>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            const bCards = document.querySelectorAll(".b");
