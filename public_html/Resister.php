...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($email_err) && empty($password_err) && empty($confirm_password_err)) {
        $sql = "INSERT INTO register (full_name,  email, password) VALUES (?,  ?, ?)";
        $stmt = mysqli_prepare($conn, $sql);
...
<div class="main">
  ...
  <?php
  if(!empty($email_err)) echo "<p style='color:red;'>$email_err</p>";
  if(!empty($password_err)) echo "<p style='color:red;'>$password_err</p>";
  if(!empty($confirm_password_err)) echo "<p style='color:red;'>$confirm_password_err</p>";
  ?>
  ...
  <form method="POST" action="">
    ...
    <div class="password-wrapper">
      ...
      <i class="fas fa-eye" onclick="togglePassword('loginPassword', this)" style="cursor:pointer;"></i>
    </div>

    <div class="password-wrapper">
      <input type="password" id="confirmPassword" name="confirm_password" placeholder="Confirm Password *" required>
      <i class="fas fa-eye" onclick="togglePassword('confirmPassword', this)" style="cursor:pointer;"></i>
    </div>

    <button type="submit">Register</button>
  </form>
     <a href="Users_login.php">Login here </a>

      <div class="note">
        Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our <div class="Raj"> <a href="#">privacy policy</a></div>.
      </div>
    </div> 
