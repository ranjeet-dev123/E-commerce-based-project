...
/>
 ...
 @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600&family=Poppins:wght@400;500&display=swap');
    ...
    .container {
      background: linear-gradient(135deg, #d44e66, #e55656);
    ...
    h1 {
      ...
      font-size: 2.8rem;
      margin-bottom: 30px;
      background: linear-gradient(90deg, #f5d186, #ffd700);
...
<a href="https://x.com/kaleen1731371?t=nGRLDTD_SbPgPfgm6wnSrw&s=09"><i class="fa-brands fa-x-twitter"></i></a>
 ...
 <div class="main">
    <div class="container">
      ...
      <p>We <strong>offer free</strong> standard shipping across <strong>India</strong> for all orders. For express
        delivery, additional charges will apply depending on your location and urgency.</p>

      <h2>International Shipping</h2>
      <p>We ship <strong>worldwide</strong>. Shipping charges for your order will be calculated and displayed at
        checkout.
        International orders may be subject to import duties and taxes (including VAT), which are incurred once the
        shipment reaches your country.</p>

      <h2>Delivery Time Estimates</h2>
      <p><strong>Domestic (India):</strong> 5-20 Business Days (Predecisions with manufacture)<br>
        <strong>International:</strong> 10-30 Business Days (depends on customs clearance and Predecisions with manufacture)
      </p>

      <h2>Order Tracking</h2>
      <p>You will receive a tracking number via email once your order has shipped. You can track your package using the
        provided tracking link.</p>

      <h2>Delays & Issues</h2>
      <p>If you have any questions or concerns regarding your order or our shipping policy, feel free to contact us at
