...
/>
  ...
  .main {
    ...
    .container {
      background: linear-gradient(135deg, #cfc57fff 0%, #fbc2eb 100%);
   ...
   <!-- body start-->
    ...
    <div class="container">
        ...
        <p>
            ...
            privacy. This Privacy Policy describes how Mirzapur Qaleen and its affiliates collect, use, share or otherwise
            process your personal information through our website (www.mirzapurqaleen.com) and mobile site
            (hereinafter referred to as the “Platform”).
        </p>

        <div class="highlight-box">
            <p>
                By visiting this Platform, providing your information, or availing our products/services, you agree to
                be bound by the terms of this Privacy Policy, Terms of Use, and applicable service terms. If you do not
        ...
        <p>
            When you use our Platform, we collect and store information provided by you from time to time. In general,
            you can browse the Platform without revealing personal data. However, once you provide personal details,
        ...
        <p>
            We may also analyze your buying behavior, interests, demographics, and preferences on an aggregated basis
        ...
        <ul>
            ...
            <li>Product recommendations & offers</li>
        ...
        <h2>Cookies</h2>
        <p>
            We use cookies to enhance your browsing experience, analyze web traffic, reduce frequency of password entry,
            and provide personalized recommendations. You may disable cookies via browser settings; however, doing so may
        ...
        <ul>
            <li>Affiliates & related companies</li>
            <li>Business partners & service providers</li>
            <li>Legal authorities (where required)</li>
        </ul>

        <p>
            We do not sell your personal information for marketing without your explicit consent.
        </p>

        <h2>Links to Other Sites</h2>
        <p>
            The Platform may contain links to other websites. We are not responsible for the privacy practices of those
            sites.
        </p>

        <h2>Security Precautions</h2>
        <p>
            We maintain physical, electronic & procedural safeguards to protect your information. Although we strive to
            secure your data, transmission over the internet is not fully secure.
        </p>

        <h2>Choice/Opt-Out</h2>
        <p>
            You may opt-out of promotional communications using your account preferences.
        </p>

        <h2>Children Information</h2>
        <p>
            Our Platform is intended for individuals above 18 years of age. We do not knowingly collect data from minors.
        </p>

        <h2>Data Retention</h2>
        <p>
            We retain data as per applicable laws and only as long as necessary for service fulfillment, legal
            compliance, or dispute resolution.
        </p>

        <h2>Your Rights</h2>
        <p>
            You may access, correct, update, or delete certain personal information by logging into your account or
            contacting us.
        </p>

        <h2>Your Consent</h2>
        <p>
            By accessing the Platform, you consent to our privacy practices stated in this policy.
        </p>

        <h2>Changes to this Privacy Policy</h2>
        <p>
            We may update this Privacy Policy periodically. Changes will be posted with an updated revision date.
        </p>

        <h2>Grievance Officer</h2>
        <div class="contact-block">
            <p>
                <b>Mr. Vijay Gupta</b><br>
                Mirzapur Qaleen<br>
                Mahant Ka Shiwala<br>
                Mirzapur – 231001<br>
                Uttar Pradesh, India<br>
                Email: <b>mirzapurkalenrugs@gmail.com</b><br>
                Phone: <b>+91 94152 05761</b><br>
                Time: Mon – Sat (10:00 AM – 08:00 PM)
            </p>
        </div>

        <h2>Customer Support</h2>
        <p>
            For queries or complaints, email: <b>mirzapurkalenrugs@gmail.com</b>
        </p>

        <h2>Queries Related to Privacy Policy</h2>
        <p>
            For privacy-related concerns, write to: <b>mirzapurkalenrugs@gmail.com</b>
        </p>
