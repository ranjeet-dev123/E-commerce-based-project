...
<head>
 ...
 <link
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Poppins&family=Great+Vibes&display=swap"
        rel="stylesheet">
  <style>
    * {
      margin: 0;
    ...
    /*   end   */
        ...
        .header {
            ...
            background: linear-gradient(135deg, #fff, #f9e4c8);
            padding: 40px 20px;
            text-align: center;
            font-size: 3em;
            color: #8c6239;
            border-bottom: 3px solid #d6b57c;
        ...
        .card {
            position: relative;
            background: linear-gradient(145deg, #ffffff, #f1e7d9);
            border-radius: 25px;
            overflow: hidden;
...
<a href="https://x.com/kaleen1731371?t=nGRLDTD_SbPgPfgm6wnSrw&s=09"><i class="fa-brands fa-x-twitter"></i></a>
 ...
 <!-- body end-->
  ...
  <div class="header" style="margin-top:18vh">
            Social Weaver & Welfare
        </div>
        ...
        <div class="content">
            <div class="section">
                <h2>Our Mission</h2>
                <p>
                    Vijay Gupta JI Weaves is passionately dedicated to uplifting the lives of our traditional artisans
                    and
                    weaver communities. Our mission goes beyond preserving ancient craftsmanship — it’s about empowering
                    families, ensuring their well-being, and fostering an environment where their art flourishes with
                    dignity and pride.

                    We are committed to creating sustainable livelihood opportunities, providing holistic support that
                    includes healthcare, education, and daily essentials. Through our social initiatives, we strive to
                    bridge the gap between heritage and modernity, ensuring that our weavers' timeless skills are not
                    only
                    preserved but also celebrated on global platforms.

                    Vijay Weaves envisions a future where artisans are not just skilled workers but proud cultural
                    ambassadors, contributing to a greener, more compassionate society through community service,
                    environmental stewardship, and social welfare programs.
                </p>
            </div>
            ...
            <div class="section">
                ...
                <div class="grid">
                    <div class="card">
                        <img src="images/MAHAKUMBH.jpg" alt="Mahakumbh">
                        <div class="info">
                            <h3>Mahakumbh Food Distribution</h3>
                            <p>Vijay Weaves organized large-scale food distribution drives at Mahakumbh, serving
                                thousands
                                of devotees with freshly prepared meals as a gesture of community service and
                                compassion.
                            </p>
                        </div>
                    </div>
                    <div class="card">
                        <img src="images/gaurya ... home.jpg" alt="Bird Homes">
                        <div class="info">
                            <h3>Bird Homes Installation</h3>
                            <p>To support urban wildlife, weavers crafted eco-friendly bird homes and installed them
                                across
                                the city, ensuring safe shelters for various bird species.</p>
                        </div>
                    </div>
                    <div class="card">
                        <img src="images/TREE.jpg" alt="Tree Plantation">
                        <div class="info">
                            <h3>Tree Plantation Drive</h3>
                            <p>Conducted extensive tree plantation campaigns to enhance green cover, promote
                                environmental
                                sustainability, and combat urban pollution.</p>
                        </div>
                    </div>

                    <div class="card">
                        <img src="images/vegitables.jpeg"
                            alt="Vegetable Support">
                        <div class="info">
                            <h3>Fruits & Daily Needs Support</h3>
                            <p>Regular distribution of fresh vegetables and essential groceries to support the
                                well-being of
                                our weaver families during challenging times.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="grid">
                    ...
                    <div class="card"><img src="images/a.jpg" alt="Gallery"></div>
                    <div class="card"><img src="images/b.jpg" alt="Gallery"></div>
                    <div class="card"><img src="images/c.jpg" alt="Gallery"></div>

                    <div class="card"><img src="images/MAHAKUMBH.jpg" alt="Gallery"></div>
                    <div class="card"><img src="images/TREE.jpg" alt="Gallery"></div>
                    <div class="card"><img src="images/gaurya ... home.jpg" alt="Gallery"></div>
