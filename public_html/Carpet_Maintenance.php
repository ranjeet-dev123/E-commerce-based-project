...
<a href="https://x.com/kaleen1731371?t=nGRLDTD_SbPgPfgm6wnSrw&s=09"><i class="fa-brands fa-x-twitter"></i></a>
  ...
  <hr style="background-color:green; width: 100%; height: 1vh; margin: 0px; padding: 0px;">
  <!-- body start-->


  <h1 style="height: 5vh; width: 100%;text-align: center; justify-content: center; color: #0792deff; margin-top: 20vh;"> coming soon............ </h1>
  <!-- body end-->
  <!-- whatsapp start-->
