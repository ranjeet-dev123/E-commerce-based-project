...
// Fetch products from `cushioncovers` table
...
<div class="product-container">
  ...
  <?php else: foreach ($products as $p): ?>
    <div class="product-card" data-name="<?php echo htmlspecialchars($p['name']); ?>">
      <?php
      // Image folder ka path "uploads/cushion covers/"
      $imgPath = 'uploads/cushion covers/' . $p['image'];
      ...
      <div class="buttons">
        <form method="POST" action="create_order.php" style="display: inline;">
            ...
            <input type="hidden" name="category" value="cushion_covers">
