...
// Fetch all Fine Indian Durrys products
...
<div class="product-container">
  ...
  <?php else: foreach ($products as $p): ?>
    <div class="product-card" data-name="<?php echo htmlspecialchars($p['name']); ?>">
      <?php
      // Image folder ka path "uploads/Fine indian durrys/"
      $imgPath = 'uploads/Fine indian durrys/' . $p['image'];
      ...
      <div class="buttons">
        <form method="POST" action="create_order.php" style="display: inline;">
            ...
            <input type="hidden" name="category" value="fine_indian_durrys">
  ...
  <div class="chat-container">
    <div class="chat-box" id="chatBox">
      ...
      <div class="chat-content">
        ...
        <div class="thank-you" id="thankYouMsg">Thank you! We'll contact you soon.</div>
      </div>
    </div>
  </div>
