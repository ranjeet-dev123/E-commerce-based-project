...
<div class="main">
    <div class="container">
      ...
      <p>All orders are processed within 2-3 business days (excluding weekends and holidays) after receiving your order
        confirmation email. You will receive another notification when your order has shipped.</p>

      <h2>Domestic Shipping</h2>
      <p>We offer <strong>free standard shipping</strong> across India for all orders. Express delivery options are
        available at an additional cost depending on your location.</p>

      <h2>International Shipping</h2>
      <p>We ship to select international locations. Shipping charges and estimated delivery times will be calculated and
        displayed at checkout. Please note that international orders may be subject to import duties and taxes, which
        are
        the responsibility of the customer.</p>

      <h2>Delivery Time Estimates</h2>
      <p><strong>Within India:</strong> 5-15 business days.<br>
        <strong>International:</strong> 10-30 business days (depending on customs clearance).
      </p>

      <h2>Order Tracking</h2>
      <p>Once your order is shipped, you will receive an email with tracking information. You can track your package
        using
        the provided link.</p>

      <h2>Delays & Issues</h2>
      <p>In case of any delays due to unforeseen circumstances such as natural calamities or strikes, we will inform you
        promptly. We are not responsible for delays caused by customs clearance for international orders.</p>

      <h2>Contact Us</h2>
      <p>For any queries related to shipping, please contact us at <strong>mirzapurkalenrugs@gmail.com</strong> or call
        <strong>+91 94152 05761</strong>.
      </p>
    </div>
  </div>
