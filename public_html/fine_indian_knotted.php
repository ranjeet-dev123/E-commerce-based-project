...
// Fetch products from `fineindianknotted` table
...
<div class="product-container">
  ...
  <?php else: foreach ($products as $p): ?>
    <div class="product-card" data-name="<?php echo htmlspecialchars($p['name']); ?>">
      <?php
      // Image folder ka path "uploads/Fine indian knotted/"
      $imgPath = 'uploads/Fine indian knotted/' . $p['image'];
      ...
      <div class="buttons">
        <form method="POST" action="create_order.php" style="display: inline;">
            ...
            <input type="hidden" name="category" value="fine_indian_knotted">
