...
{
    $err = "User session detected. Please logout first to access admin login.";
}

// Config - exact path ke saath
$config_path = __DIR__ . '/config.php';
if (!file_exists($config_path)) {
    die("ERROR: config.php nahi mila! <br>
    Path: " . $config_path . "<br>
    Please create config.php file in: " . __DIR__);
}
...
if(empty($err))
{
  $sql = "SELECT id, email, password FROM admin1 WHERE email = ?";
    ...
    <div class="main">
        ...
        <div class="form-section">
            ...
            <form method="POST" action="">
                ...
                <div class="Raj">
                    <a href="Users_login.php">User Login</a>
